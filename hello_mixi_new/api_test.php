...
class	APITest
{
	var	$opensocial_owner_id;
	var	$opensocial_viewer_id;

	function	__construct($session_info)
	{
		$this->opensocial_owner_id = $session_info['opensocial_owner_id'];
		$this->opensocial_viewer_id = $session_info['opensocial_viewer_id'];
	}
